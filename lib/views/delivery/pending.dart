...
class PendingDeliveriesDetails extends StatefulWidget {
  final String mPincode;
  PendingDeliveriesDetails(this.mPincode, {Key key}) : super(key: key);
  @override
  _PendingDeliveriesDetailsState createState() =>
      _PendingDeliveriesDetailsState();
}

class _PendingDeliveriesDetailsState extends State<PendingDeliveriesDetails> {
  ...
  _fetchDeliveries() async {
    try {
      ...
      final response = await http.post(Constants().pendingDeliveries,
                    ...
                    child: SingleChildScrollView(
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          InkWell(
                            onTap: () {
                              _makePhoneCall('tel:' + deliveryPojo.bmobile.toString());
                            },
                            child: Container(
                              alignment: Alignment.topLeft,
                              padding: EdgeInsets.only(
