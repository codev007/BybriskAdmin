...
class _PickedState extends State<Picked> with AutomaticKeepAliveClientMixin {
    ...
    return InkWell(
      onTap: () {
        Navigator.of(context)
            .push(FadeRouteBuilder(page: PickedDeliveries(overview.pincode)));
      },
      child: Container(
        padding:
  ...
  _fetchDeliveries() async {
    try {
      ...
      final response =
          await http.get(Constants().pickedOverview, headers: headers);
