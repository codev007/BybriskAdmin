...
import 'package:bybrisk_admin/views/delivery/shipping.dart';
...
class _ShippingState extends State<Shipping>
    ...
    return InkWell(
      onTap: () {
        Navigator.of(context)
            .push(FadeRouteBuilder(page: ShippingDeliveries(overview.pincode)));
      },
      child: Container(
        padding:
  ...
  _fetchDeliveries() async {
    try {
      ...
      final response =
          await http.get(Constants().shippingOverview, headers: headers);
